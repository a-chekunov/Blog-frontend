...
const mapStateToProps = ({ posts }, { location: { pathname } }) => {
	...
	return !posts.items
		? {}
		: posts.items.filter((post) => post._id === postId)[0];
};

HeaderBlock.defaultProps = {
	title: "ReactJS and NodeJS Blog",
	description: "My test blog on ReactJS and MongoDB",
	imageUrl:
...
export default withRouter(connect(mapStateToProps, null)(HeaderBlock));
